...
# [DaViT: Dual Attention Vision Transformer](https://arxiv.org/pdf/2204.03645.pdf)
This is a warehouse for DaViT-Pytorch-model, can be used to train your image-datasets for classification tasks.
The code mainly comes from official [source code](https://github.com/dingmyu/davit)

## Preparation
### Download the pretrained_weights
[pretrained_weights_website](https://github.com/dingmyu/davit)
...
├── models: DaViT Model
    ├── davit.py: Construct "DaViT" model
├── util:
