...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'DaViT training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='DaViT_base', type=str, metavar='MODEL',
                        choices=['DaViT_tiny', 'DaViT_base', 'DaViT_small', 'DaViT_large_window12_384'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'DaViT training and evaluation script', parents=[get_args_parser()])
